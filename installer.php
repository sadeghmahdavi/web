...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210428_d982d8a7d984d8a8d8a2d8b3d8aad8_d8765f5cc596b2125892_20210428131733_archive.zip';
	const ARCHIVE_SIZE		 = '76136204';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'd8765f5-28131733';
    const SECONDARY_PACKAGE_HASH = '313810b-28131733';
	const VERSION			 = '1.4.0';
